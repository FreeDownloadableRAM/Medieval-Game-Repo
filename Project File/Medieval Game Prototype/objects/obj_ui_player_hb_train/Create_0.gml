...
// Unit Type
unit_train_type = obj_halberdier; // pikeman is default
unit_train_sprite = spr_hb_unit_icon;
unit_train_cd_object = obj_unit_train_cd;
unit_train_time = 900; // in fps (60 = 1 second)
unit_train_timer = 0; // in fps (60 = 1 second)
unit_train_cost = global.unit_halberd_cost;
...
// UI Placement
unit_icon_placement_offset_x = 544;
