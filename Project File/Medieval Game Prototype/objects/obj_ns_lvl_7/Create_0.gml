...
icon_nation = spr_lvl_07_n;
icon_nation_hlight = spr_lvl_07_nh;
lvl_dstnation = rm_lvl_07_alliance_of_arms;
icon_nation_cmplt = spr_lvl_07_cmplt;
lvl_complete = global.lvl_7_clear;
