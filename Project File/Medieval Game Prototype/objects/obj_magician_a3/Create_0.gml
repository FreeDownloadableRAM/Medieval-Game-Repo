...
else if (global.slot_four_colour == 1){
	// 0 = green
...
else if (global.slot_four_colour == 2){
	// 2 = cyan
...
else if (global.slot_four_colour == 3){
	// 3 = purple
...
else if (global.slot_four_colour == 4){
	// 4 = red
...
else if (global.slot_four_colour == 5){
	// 5 = orange
...
else if (global.slot_four_colour == 6){
	// 6 = yellow
...
death_character = obj_magician_dead_a3;

// Help AI track Information
global.ally_3_mg_count = global.ally_3_mg_count + 1;
