...
icon_nation = spr_lvl_04_n;
icon_nation_hlight = spr_lvl_04_nh;
lvl_dstnation = rm_lvl_04_warm_farm_fields;
icon_nation_cmplt = spr_lvl_04_cmplt;
lvl_complete = global.lvl_4_clear;
...
// Nation Info
n_flag = spr_lvl_04_flag;

// unit unlock info
n_unit_unlock = spr_ab_unlock_icon;
...
if (global.lvl_2_clear == true || global.lvl_3_clear || global.lvl_5_clear == true || global.lvl_8_clear){
