...
if (global.is_game_paused == true){
	...
	// account for it here
	global.player_castle_health -= (global.halberd_atk_slash - (global.halberd_atk_slash * castle_slash_defence));
	global.player_castle_health -= (global.halberd_atk_thrust - (global.halberd_atk_thrust * castle_thrust_defence));
