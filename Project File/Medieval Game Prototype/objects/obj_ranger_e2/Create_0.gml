...
death_character = obj_ranger_dead_e2;

// Help AI track Information
global.enemy_2_rg_count = global.enemy_2_rg_count + 1;

// retreat offset
ai_range_retreat_offset = (irandom_range(1,8))*4;

// colour palette properties
colour_palette_index = global.slot_six_colour; // 0 def, 1-3 allies, 4 enemy def, 5-7 enemy allies
