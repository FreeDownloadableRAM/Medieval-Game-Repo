...
// here we track what units enemies are using
...
opposition_king_health = global.player_castle_health_enemy / global.starting_player_castle_health_enemy;
allies_king_health = global.player_castle_health / global.starting_player_castle_health;
...
if (allied_unit_amount == 0){
	...
	allied_ranged_army_percent = allied_total_rg_units / (global.player_unit_count + global.ally_1_unit_count + global.ally_2_unit_count + global.ally_3_unit_count);
