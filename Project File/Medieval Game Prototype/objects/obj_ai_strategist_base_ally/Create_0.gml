...
can_train_sm = global.ally_1_can_train_sm;
can_train_pm = global.ally_1_can_train_pm;
can_train_rg = global.ally_1_can_train_rg;
can_train_kn = global.ally_1_can_train_kn;
...
ai_swordsman = obj_swordman_a1;
ai_pikeman = obj_pikeman_a1;
ai_ranger = obj_ranger_a1;
ai_knight = obj_knight_a1;
ai_arbalest = obj_arbalest_a1;
...
opposition_sm_amount = global.enemy_sm_count + global.enemy_2_sm_count + global.enemy_3_sm_count + global.enemy_4_sm_count;
opposition_pm_amount = global.enemy_pm_count + global.enemy_2_pm_count + global.enemy_3_pm_count + global.enemy_4_pm_count;
opposition_rg_amount = global.enemy_rg_count + global.enemy_2_rg_count + global.enemy_3_rg_count + global.enemy_4_rg_count;
opposition_kn_amount = global.enemy_kn_count + global.enemy_2_kn_count + global.enemy_3_kn_count + global.enemy_4_kn_count;
opposition_ab_amount = global.enemy_ab_count + global.enemy_2_ab_count + global.enemy_3_ab_count + global.enemy_4_ab_count;
...
// total
opposition_unit_amount = global.player_unit_count_enemy + global.enemy_2_unit_count + global.enemy_3_unit_count + global.enemy_4_unit_count;
...
alarm_set(9,(irandom_range(30,120) / (delta_time/1000000))); // after 30-120 seconds, set ai_restrict_attack_order to false.
...
eco_up_ch_thres_lv_1 = 0.9;
eco_up_ch_thres_lv_2 = 0.5;
eco_up_ch_thres_lv_3 = 0.4;
eco_up_ch_thres_lv_4 = 0.3;
...
ai_patience = ((irandom_range(5,10) * 60) / (delta_time/1000000)); // 5 to 10 mins randomly
