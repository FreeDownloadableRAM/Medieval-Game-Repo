...
if (global.is_game_paused == true){
	...
	// account for it here
	character_health -= (global.halberd_atk_slash - (global.halberd_atk_slash * character_slash_defence));
	character_health -= (global.halberd_atk_thrust - (global.halberd_atk_thrust * character_thrust_defence));
