...
can_train_sm = global.enemy_4_can_train_sm;
can_train_pm = global.enemy_4_can_train_pm;
can_train_rg = global.enemy_4_can_train_rg;
can_train_kn = global.enemy_4_can_train_kn;
...
ai_swordsman = obj_swordman_e4;
ai_pikeman = obj_pikeman_e4;
ai_ranger = obj_ranger_e4;
ai_knight = obj_knight_e4;
ai_arbalest = obj_arbalest_e4;
...
cntr_p_army_range_thres = 0.4; // if the player army is made up of x% ranged units
cntr_p_army_sm_thres = 0.5; // if the player army is made up of x% swordman units
cntr_p_army_pm_thres = 0.45; // if the player army is made up of x% pikeman units
cntr_p_army_rg_thres = 0.2; // if the player army is made up of x% ranger units
cntr_p_army_kn_thres = 0.35; // if the player army is made up of x% knight units
...
cntr_p_army_mg_thres = 0.15; // if the player army is made up of x% magician units
...
eco_up_ch_thres_lv_2 = 0.95;
eco_up_ch_thres_lv_3 = 0.35;
eco_up_ch_thres_lv_4 = 0.25;
eco_up_ch_thres_lv_5 = 0.15;
...
our_gold_amount = global.enemy_4_gold_start_amount * global.slot_eight_eco_start_multiplier;

our_gold_gen = global.enemy_4_gold_gen * global.slot_eight_eco_gen_multiplier;
our_gold_cap = global.enemy_4_gold_cap * global.slot_eight_eco_cap_multiplier;
