...
else if (global.slot_seven_colour == 1){
	// 0 = green
...
else if (global.slot_seven_colour == 2){
	// 2 = cyan
...
else if (global.slot_seven_colour == 3){
	// 3 = purple
...
else if (global.slot_seven_colour == 4){
	// 4 = red
...
else if (global.slot_seven_colour == 5){
	// 5 = orange
...
else if (global.slot_seven_colour == 6){
	// 6 = yellow
...
death_character = obj_magician_dead_e3;

// Help AI track Information
global.enemy_3_mg_count = global.enemy_3_mg_count + 1;
