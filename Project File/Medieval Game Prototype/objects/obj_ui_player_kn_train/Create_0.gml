...
// Unit Type
unit_train_type = obj_knight; // pikeman is default
unit_train_sprite = spr_kn_unit_icon;
unit_train_cd_object = obj_unit_train_cd;
unit_train_time = 600; // in fps (60 = 1 second)
unit_train_timer = 0; // in fps (60 = 1 second)
unit_train_cost = global.unit_knight_cost;
...
// UI Placement
unit_icon_placement_offset_x = 352;
