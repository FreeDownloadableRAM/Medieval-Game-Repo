...
icon_nation = spr_lvl_11_n;
icon_nation_hlight = spr_lvl_11_nh;
lvl_dstnation = rm_lvl_11_ice_fields;
icon_nation_cmplt = spr_lvl_11_cmplt;
lvl_complete = global.lvl_11_clear;
