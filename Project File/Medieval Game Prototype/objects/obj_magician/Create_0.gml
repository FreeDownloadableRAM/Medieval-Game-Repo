...
else if (global.slot_one_colour == 1){
	// 0 = green
...
else if (global.slot_one_colour == 2){
	// 2 = cyan
...
else if (global.slot_one_colour == 3){
	// 3 = purple
...
else if (global.slot_one_colour == 4){
	// 4 = red
...
else if (global.slot_one_colour == 5){
	// 5 = orange
...
else if (global.slot_one_colour == 6){
	// 6 = yellow
...
death_character = obj_magician_dead;

// Help AI track Information
global.player_mg_count = global.player_mg_count + 1;
