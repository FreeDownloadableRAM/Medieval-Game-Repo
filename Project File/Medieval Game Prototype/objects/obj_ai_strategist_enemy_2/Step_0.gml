...
if (global.is_game_paused == true){
	...
	if ((ai_eco_up_save == false) && (global.enemy_2_unit_count < global.enemy_2_unit_cap) && allies_king_health > 0.25){
			...
			if (opposition_army_range_to_melee_ratio >= cntr_p_army_rg_thres){
				...
				if (can_train_rg == true || can_train_ab == true || can_train_nc == true){
					...
					if (allied_ranged_army_percent < allied_ranged_army_perc_targ && (alarm[4] <= 0 || alarm[2] <= 0 || alarm[11] <= 0) && (can_train_rg == true || can_train_ab == true || can_train_nc == true)){
						...
						if (alarm[4] <= 0 && our_gold_amount >= global.unit_arbalest_cost && can_train_ab == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
						...
						if (alarm[2] <= 0 && our_gold_amount >= global.unit_ranger_cost && can_train_rg == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						if (alarm[11] <= 0 && our_gold_amount >= global.unit_necromancer_cost && can_train_nc == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
					...
					// If we do not have access to ANY melee units, just train ranged units without caring for range army % targets.
						...
						// Halberd training
						if (alarm[5] <= 0 && our_gold_amount >= global.unit_halberd_cost && can_train_hb == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// Knight training
						if (alarm[3] <= 0 && our_gold_amount >= global.unit_knight_cost && can_train_kn == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// pikeman training
						if (alarm[1] <= 0 && our_gold_amount >= global.unit_pikeman_cost && can_train_pm == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// swordman training
						if (alarm[0] <= 0 && our_gold_amount >= global.unit_swordman_cost && can_train_sm == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
				...
				// If we dont:
					...
					// Train these units in upper most priority (most expensive to least expensive)
					if (alarm[10] <= 0 && our_gold_amount >= global.unit_magician_cost && can_train_mg == true && global.enemy_2_unit_count < global.enemy_2_unit_cap){
						// alarm is at 0s, and we have the funds, and this unit is available.
						// Debug
		...
		// the bulk of their army is made up of rangers and arbalests
			...
			if ((can_train_hb == true || can_train_kn == true || can_train_nc == true) && (can_train_rg == true)){
				...
				if (allied_ranged_army_percent < allied_ranged_army_perc_targ && (alarm[2] <= 0 || alarm[10] <= 0)){
						...
						if (alarm[10] <= 0 && our_gold_amount >= global.unit_magician_cost && can_train_mg == true && global.enemy_2_unit_count < global.enemy_2_unit_cap && opposition_hb_amount > 0){
						// alarm is at 0s, and we have the funds, and this unit is available.
						// Debug
	...
	else if ((ai_eco_up_save == false) && (global.enemy_2_unit_count < global.enemy_2_unit_cap) && allies_king_health <= 0.25){
		...
		if (opposition_army_range_to_melee_ratio > cntr_p_army_range_thres){
			...
			if ((can_train_kn == true || can_train_hb == true) && (allied_kn_amount || allied_hb_amount > 0)){
				if ((opposition_unit_amount >= ((allied_kn_amount + allied_hb_amount) * 10.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.player_order == 2 || global.ally_1_order == 2 || global.ally_2_order == 2 || global.ally_3_order == 2)){
					...
					// Retreat
					global.enemy_2_order = 0; // Retreat
