...
icon_nation = spr_lvl_01_n;
icon_nation_hlight = spr_lvl_01_nh;
icon_nation_cmplt = spr_lvl_01_cmplt;
lvl_dstnation = rm_lvl_01_tut;
lvl_complete = global.lvl_1_clear;
...
// Nation Info
n_flag = spr_lvl_01_flag;

// unit unlock info
n_unit_unlock = spr_rg_unlock_icon;
...
if (global.lvl_1_clear == false){
	// If we didnt clear it already, make it selectable so we dont soft lock
	can_play_lvl = true;
}
else {
