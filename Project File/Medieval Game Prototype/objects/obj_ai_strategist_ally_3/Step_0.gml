...
if (global.is_game_paused == true){
	...
	if ((ai_eco_up_save == false) && (global.ally_3_unit_count < global.ally_3_unit_cap) && allies_king_health > 0.25){
			...
			if (opposition_army_range_to_melee_ratio >= cntr_p_army_rg_thres){
				...
				if (can_train_rg == true || can_train_ab == true || can_train_nc == true){
					...
					if (allied_ranged_army_percent < allied_ranged_army_perc_targ && (alarm[4] <= 0 || alarm[2] <= 0 || alarm[11] <= 0) && (can_train_rg == true || can_train_ab == true || can_train_nc == true)){
						...
						if (alarm[4] <= 0 && our_gold_amount >= global.unit_arbalest_cost && can_train_ab == true && global.ally_3_unit_count < global.ally_3_unit_cap){
						...
						if (alarm[2] <= 0 && our_gold_amount >= global.unit_ranger_cost && can_train_rg == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						if (alarm[11] <= 0 && our_gold_amount >= global.unit_necromancer_cost && can_train_nc == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
					...
					// If we do not have access to ANY melee units, just train ranged units without caring for range army % targets.
						...
						// Halberd training
						if (alarm[5] <= 0 && our_gold_amount >= global.unit_halberd_cost && can_train_hb == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// Knight training
						if (alarm[3] <= 0 && our_gold_amount >= global.unit_knight_cost && can_train_kn == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// pikeman training
						if (alarm[1] <= 0 && our_gold_amount >= global.unit_pikeman_cost && can_train_pm == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
						...
						// swordman training
						if (alarm[0] <= 0 && our_gold_amount >= global.unit_swordman_cost && can_train_sm == true && global.ally_3_unit_count < global.ally_3_unit_cap){
							// alarm is at 0s, and we have the funds, and this unit is available.
							// Debug
				...
				// If we dont:
					...
					// Train these units in upper most priority (most expensive to least expensive)
					if (alarm[10] <= 0 && our_gold_amount >= global.unit_magician_cost && can_train_mg == true && global.ally_3_unit_count < global.ally_3_unit_cap){
						// alarm is at 0s, and we have the funds, and this unit is available.
						// Debug
		...
		// the bulk of their army is made up of rangers and arbalests
			...
			if ((can_train_hb == true || can_train_kn == true || can_train_nc == true) && (can_train_rg == true)){
				...
				if (allied_ranged_army_percent < allied_ranged_army_perc_targ && (alarm[2] <= 0 || alarm[10] <= 0)){
						...
						if (alarm[10] <= 0 && our_gold_amount >= global.unit_magician_cost && can_train_mg == true && global.ally_3_unit_count < global.ally_3_unit_cap && opposition_hb_amount > 0){
						// alarm is at 0s, and we have the funds, and this unit is available.
						// Debug
	...
	else if ((ai_eco_up_save == false) && (global.ally_3_unit_count < global.ally_3_unit_cap) && allies_king_health <= 0.25){
	...
	if ((ai_restrict_attack_order == false) && (ai_patience > 0)){
		...
		if (opposition_army_range_to_melee_ratio > cntr_p_army_range_thres){
			...
			if ((can_train_kn == true || can_train_hb == true) && (allied_kn_amount || allied_hb_amount > 0)){
				if ((opposition_unit_amount >= ((allied_kn_amount + allied_hb_amount) * 10.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 10x the amount of knights and halberdiers
					// AND King health is greater than 30%
					// Retreat
					global.ally_3_order = 0; // Retreat
			...
			// If the AI does not have access to knights, but does have access to swordmen and pikemen
				...
				if ((opposition_unit_amount >= ((allied_sm_amount + allied_pm_amount) * 4.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
			...
			// ai only has access to magicians
				...
				global.ally_3_order = 2;
			}
			// ai only has access to ranged units
			else {
				if ((opposition_unit_amount >= ((allied_rg_amount + allied_ab_amount) * 2.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
		...
		// Player is swords army type
			...
			// If the AI does not have access to knights, but does have access to swordmen and pikemen
				...
				if ((opposition_unit_amount >= ((allied_sm_amount + allied_pm_amount) * 2.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 2x the amount of swordmen and pikemen
					// AND King health is greater than 30%
					// Retreat
					global.ally_3_order = 0; // Retreat
			...
			// ai only has access to magicians
				...
				// player has no range, so you can be more choose-y
					...
					// halberdiers
					if((opposition_hb_amount > 0) && (allied_mg_amount < 5) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// knights
					else if((opposition_kn_amount > 0) && (allied_mg_amount < 4) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// knights
					else if((opposition_pm_amount > 0 || opposition_sm_amount > 0) && (allied_mg_amount < 3) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// if player has 5 or more halberdiers and we dont have sufficient amount of magicians to defend (less than 10)
					else if((opposition_hb_amount > 4) && (allied_mg_amount < 10) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// if player has 10 or more knights and we dont have sufficient amount of magicians to defend (less than 7)
					else if((opposition_kn_amount > 10) && (allied_mg_amount < 7) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// if player has 15 or more pikemen and we dont have sufficient amount of magicians to defend (less than 5)
					else if((opposition_pm_amount > 14) && (allied_mg_amount < 5) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// if player has 15 or more swordmen and we dont have sufficient amount of magicians to defend (less than 3)
					else if((opposition_sm_amount > 14) && (allied_mg_amount < 3) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
						global.ally_3_order = 0;
					}
					// under which situation do we defend?
					// the next four are the same as above, but player is not attacking
					else if((opposition_hb_amount > 4) && (allied_mg_amount < 10) && (allies_king_health > ai_def_cutoff_perc) && (global.enemy_order != 2 && global.enemy_2_order != 2  && global.enemy_3_order != 2  && global.enemy_4_order != 2)){
						global.ally_3_order = 1;
					}
					// if player has 10 or more knights and we dont have sufficient amount of magicians to defend (less than 7)
					else if((opposition_kn_amount > 10) && (allied_mg_amount < 7) && (allies_king_health > ai_def_cutoff_perc) && (global.enemy_order != 2 && global.enemy_2_order != 2  && global.enemy_3_order != 2  && global.enemy_4_order != 2)){
						global.ally_3_order = 1;
					}
					// if player has 15 or more pikemen and we dont have sufficient amount of magicians to defend (less than 5)
					else if((opposition_pm_amount > 14) && (allied_mg_amount < 5) && (allies_king_health > ai_def_cutoff_perc) && (global.enemy_order != 2 && global.enemy_2_order != 2  && global.enemy_3_order != 2  && global.enemy_4_order != 2)){
						global.ally_3_order = 1;
					}
					// if player has 15 or more swordmen and we dont have sufficient amount of magicians to defend (less than 3)
					else if((opposition_sm_amount > 14) && (allied_mg_amount < 3) && (allies_king_health > ai_def_cutoff_perc) && (global.enemy_order != 2 && global.enemy_2_order != 2  && global.enemy_3_order != 2  && global.enemy_4_order != 2)){
						global.ally_3_order = 1;
					}
			...
			// ai only has access to ranged units
				...
				if ((opposition_unit_amount >= ((allied_rg_amount + allied_ab_amount) * 2.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					...
					&& (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 2x the amount of rangers and arbalests
		...
		// Player is Pikes army type
			...
			// If the AI has access to knights or halberdiers
			if ((can_train_kn == true || can_train_hb == true) && (allied_kn_amount || allied_hb_amount > 0)){
				if ((opposition_unit_amount >= ((allied_kn_amount + allied_hb_amount) * 3.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
		...
		// Player is knights army type
			...
			// If the AI has access to knights or halberdiers
			if ((can_train_kn == true || can_train_hb == true) && (allied_kn_amount || allied_hb_amount > 0)){
				if ((opposition_unit_amount >= ((allied_kn_amount + allied_hb_amount) * 2.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
			...
			// If the AI does not have access to knights, but does have access to swordmen and pikemen
				...
				if ((opposition_unit_amount >= ((allied_sm_amount + allied_pm_amount) * 1.75) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 2x the amount of swordmen and pikemen
					// AND King health is greater than 30%
					// Retreat
					global.ally_3_order = 0; // Retreat
			...
			// ai only has access to ranged units
				...
				if ((opposition_unit_amount >= ((allied_rg_amount + allied_ab_amount) * 1.0) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
		...
		// Player is Halberdier army type
			...
			// If the AI has access to knights or halberdiers
			if ((can_train_kn == true || can_train_hb == true) && (allied_kn_amount || allied_hb_amount > 0)){
				if ((opposition_unit_amount >= ((allied_kn_amount + allied_hb_amount) * 1.5) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 1.5x the amount of knights and halberdiers
					// AND King health is greater than 30%
					// Retreat
					global.ally_3_order = 0; // Retreat
			...
			// If the AI does not have access to knights, but does have access to swordmen and pikemen
				...
				if ((opposition_unit_amount >= ((allied_sm_amount + allied_pm_amount) * 1.25) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
					// If the player has 1.25x the amount of swordmen and pikemen
					// AND King health is greater than 30%
					// Retreat
					global.ally_3_order = 0; // Retreat
			...
			// ai only has access to ranged units
				...
				if ((opposition_unit_amount >= ((allied_rg_amount + allied_ab_amount) * 0.75) && (allies_king_health > ai_retr_cutoff_perc)) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
		...
		// No counter situations, run generic logic
			...
			if ((can_train_mg == true) && (can_train_sm == false && can_train_pm == false && can_train_rg == false && can_train_kn == false && can_train_ab == false && can_train_hb == false)){
				...
				if ((opposition_unit_amount > (allied_unit_amount * 1.5)) && (allies_king_health > ai_retr_cutoff_perc) && (global.enemy_order == 2 || global.enemy_2_order == 2 || global.enemy_3_order == 2 || global.enemy_4_order == 2)){
	...
	// for ui updates
	ui_ai_order = global.ally_3_order;
