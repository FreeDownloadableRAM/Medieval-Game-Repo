...
icon_nation = spr_lvl_10_n;
icon_nation_hlight = spr_lvl_10_nh;
lvl_dstnation = rm_lvl_10_ice_mountains;
icon_nation_cmplt = spr_lvl_10_cmplt;
lvl_complete = global.lvl_10_clear;
...
if (global.lvl_8_clear == true || global.lvl_9_clear == true){
