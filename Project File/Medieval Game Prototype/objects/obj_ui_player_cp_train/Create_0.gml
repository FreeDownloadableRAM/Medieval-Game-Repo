...
// Unit Type
unit_train_type = obj_catapult; // pikeman is default
unit_train_sprite = spr_cp_unit_icon;
unit_train_cd_object = obj_unit_train_cd;
unit_train_time = 60 * global.ai_train_delay_cp; // in fps (60 = 1 second)
unit_train_timer = 0; // in fps (60 = 1 second)
unit_train_cost = global.unit_catapult_cost;
...
unit_spawn_location_y = global.spawn_height - 32;

// UI Placement
unit_icon_placement_offset_x = 736; // 96 + 64n
