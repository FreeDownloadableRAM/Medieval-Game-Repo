...
else if (global.slot_three_colour == 1){
	// 0 = green
...
else if (global.slot_three_colour == 2){
	// 2 = cyan
...
else if (global.slot_three_colour == 3){
	// 3 = purple
...
else if (global.slot_three_colour == 4){
	// 4 = red
...
else if (global.slot_three_colour == 5){
	// 5 = orange
...
else if (global.slot_three_colour == 6){
	// 6 = yellow
...
death_character = obj_magician_dead_a2;

// Help AI track Information
global.ally_2_mg_count = global.ally_2_mg_count + 1;
