...
// Unit Type
unit_train_type = obj_arbalest; // pikeman is default
unit_train_sprite = spr_ab_unit_icon;
unit_train_cd_object = obj_unit_train_cd;
unit_train_time = 720; // in fps (60 = 1 second)
unit_train_timer = 0; // in fps (60 = 1 second)
unit_train_cost = global.unit_arbalest_cost;
...
// UI Placement
unit_icon_placement_offset_x = 448;
