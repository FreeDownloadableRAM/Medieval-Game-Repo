...
character_idle_anim = spr_kn_00_idle_enemy;
character_ready_anim = spr_kn_01_ready_enemy;
character_walk_anim = spr_kn_02_walking_enemy;
character_run_anim = spr_kn_03_running_enemy;
character_attack_anim_1 = spr_kn_04_attacking_1_enemy;
character_attack_hitbox_1 = obj_knight_atk_hitbox_enemy;
character_defend_anim = spr_kn_05_defend_enemy;
character_death_anim_1 = spr_kn_06_death_1_enemy;
...
death_character = obj_knight_dead_enemy;

// Help AI track Information
global.enemy_kn_count = global.enemy_kn_count + 1;