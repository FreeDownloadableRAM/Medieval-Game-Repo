...
character_idle_anim = spr_hb_00_idle_indx;
character_ready_anim = spr_hb_01_ready_indx;
character_walk_anim = spr_hb_02_walking_indx;
character_run_anim = spr_hb_03_running_indx;
character_attack_anim_1 = spr_hb_04_attacking_1_indx;
character_attack_hitbox_1 = obj_halberdier_atk_hitbox_enemy;
character_defend_anim = spr_hb_05_defend_indx;
character_death_anim_1 = spr_hb_06_death_1_indx;
...
death_character = obj_halberdier_dead_e4;

// Help AI track Information
global.enemy_4_hb_count = global.enemy_4_hb_count + 1;

// colour palette properties
colour_palette_index = global.slot_eight_colour; // 0 def, 1-3 allies, 4 enemy def, 5-7 enemy allies

// palette sprites
col_pal_idle = spr_hb_indx_col_plte_00_idle;
col_pal_ready = spr_hb_indx_col_plte_01_rdy;
col_pal_walk = spr_hb_indx_col_plte_02_walk;
col_pal_run = spr_hb_indx_col_plte_03_run;
col_pal_attack = spr_hb_indx_col_plte_04_atk;
col_pal_defend = spr_hb_indx_col_plte_05_def;