...
// Unit Type
unit_train_type = obj_necromancer; // pikeman is default
unit_train_sprite = spr_nc_unit_icon;
unit_train_cd_object = obj_unit_train_cd;
unit_train_time = 60 * global.ai_train_delay_nc; // in fps (60 = 1 second)
unit_train_timer = 0; // in fps (60 = 1 second)
unit_train_cost = global.unit_necromancer_cost;
...
// UI Placement
unit_icon_placement_offset_x = 832; // 96 + 64n
