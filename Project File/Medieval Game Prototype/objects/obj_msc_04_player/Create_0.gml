...
// Audio track to play
music_track = snd_msc_04_standing_orders_loopable;
...
// Beats per Bar: 3 
// beat offset: 0
// # of Bars: 52 (?? dunno this one, will have to get it thru trial and error)
