...
// resource
// https://manual.gamemaker.io/monthly/en/GameMaker_Language/GML_Reference/Asset_Management/Audio/Audio_Loop_Points/Audio_Loop_Points.htm
// Stop ALL audio FIRST
audio_stop_all();

// Track Info
music_bpm = 168; // beats per min, this is in quarternotes
beats_p_bar = 3; // 4 beats in a bar
beat_st_offset = 0; // beats before music starts playing in the track, THESE ARE IN QUARTER NOTES
amount_of_bars = 80; // amount of bars of music
loopable = true;
...
//alarm_set(0,(((beat_st_offset * beats_p_bar) * time_bpm_to_seconds(music_bpm)) * ((delta_time / 1000000) * fps)));

// Audio track to play
music_track = snd_msc_14_mainmenu_alt_loopable;
