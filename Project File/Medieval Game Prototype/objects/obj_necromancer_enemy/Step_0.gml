...
// We aren't paused so run character logic
	...
	if (in_attack_anim == true){
		...
		if (character_attack_animation_duration > 0){
			...
			if ((character_attack_animation_duration > character_anim_launch_frame - 1.0) && (character_attack_animation_duration < (character_anim_launch_frame))){
			
				if (summon_countdown > 0){
					// summon attack projectiles
					instance_create_layer(x+24,y+4,"hitbox_layer",character_attack_projectile);
				
					instance_create_layer(x-28,y+4,"hitbox_layer",character_attack_projectile);
				
					instance_create_layer(x-8,y+4,"projectile_effects",character_attack_projectile);
					...
					instance_create_layer(x+64,704,"Targets",obj_ghoul_summon_enemy);
				
					instance_create_layer(x-32,704,"Targets",obj_ghoul_summon_enemy);
				
					instance_create_layer(x+8,704,"Targets",obj_ghoul_summon_enemy);
