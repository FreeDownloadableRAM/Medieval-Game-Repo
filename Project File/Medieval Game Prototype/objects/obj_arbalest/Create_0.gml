...
character_attack_projectile = obj_arbalest_bolt;
...
ai_rally_distance_offset = (irandom_range(128,64)) * 4;
ai_attack_distance_offset = (irandom_range(0,8)) * 4;
// ai_rally_distance_offset = 0;

//on death spawn this obj
death_character = obj_arbalest_dead;

// Help AI track Information
global.player_ab_count = global.player_ab_count + 1;
